...
const Data = () => {
    return (
        <div className="home_data">
            <h1 className="home_title">Tselote Yonas
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home_description">I am a Software Engineering graduate who is eager to contribute my skills and gain valuable experience as well as
                pursue a career in full stack web development.</p>
